...
def finetune_model(object):
    ...
    filepath = f"{config.FILTERED_DIR}/{object}_code_finetuning.jsonl"
    ...
    if model_id:
        ...
        output_file = f"{config.FILTERED_DIR}/{object}_code_model_info.json"
...
if __name__ == "__main__":
    ...
    # Finetune for each object (code experiment uses animals only)
    models = {}
    for object in config.ANIMALS + ["control"]:
